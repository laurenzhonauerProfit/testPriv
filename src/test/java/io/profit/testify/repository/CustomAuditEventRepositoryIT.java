package io.profit.testify.repository;

import io.profit.testify.PrivApp;

import io.profit.testify.config.Constants;
import io.profit.testify.config.audit.AuditEventConverter;
import io.profit.testify.domain.PersistentAuditEvent;
...
import static io.profit.testify.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
